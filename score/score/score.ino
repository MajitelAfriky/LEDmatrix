...
void randomizer() {
  ...
  String n1s = data.substring(0, commaPos);
  play = n1s.toInt();

  String n2s = data.substring(commaPos +1);
  oPlay = n2s.toInt();
...
void one(int o) {
  ...
  leds[o+24] = CRGB(255, 0, 0);
  leds[o+25] = CRGB(255, 0, 0);  
  leds[o+26] = CRGB(255, 0, 0);
  leds[o+27] = CRGB(255, 0, 0);
  leds[o+28] = CRGB(255, 0, 0);
  leds[o+19] = CRGB(255, 0, 0);
  leds[o+10] = CRGB(255, 0, 0);
  FastLED.show();
}

void two(int o) {
  FastLED.setBrightness(255);
  leds[o+0] = CRGB(255, 0, 0);
  leds[o+8] = CRGB(255, 0, 0);
  leds[o+16] = CRGB(255, 0, 0);
  leds[o+24] = CRGB(255, 0, 0);
  leds[o+9] = CRGB(255, 0, 0);
  leds[o+18] = CRGB(255, 0, 0);
  leds[o+27] = CRGB(255, 0, 0);
  leds[o+20] = CRGB(255, 0, 0);
  leds[o+12] = CRGB(255, 0, 0);
  leds[o+3] = CRGB(255, 0, 0);
  FastLED.show();
}

void three(int o) {
  FastLED.setBrightness(255);
  leds[o+1] = CRGB(255, 0, 0);
  leds[o+8] = CRGB(255, 0, 0);
  leds[o+16] = CRGB(255, 0, 0);
  leds[o+25] = CRGB(255, 0, 0);
  leds[o+18] = CRGB(255, 0, 0);
...
void four(int o) {
  ...
  leds[o+28] = CRGB(255, 0, 0);
  leds[o+20] = CRGB(255, 0, 0);
  leds[o+11] = CRGB(255, 0, 0);
  leds[o+2] = CRGB(255, 0, 0);
  leds[o+10] = CRGB(255, 0, 0);
  leds[o+18] = CRGB(255, 0, 0);
  FastLED.show();
}
